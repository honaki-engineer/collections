                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full" id="tech_type_section">
                                            <div class="relative">
                                                <label for="tech_type" class="leading-7 text-sm text-gray-600">▪️
                                                    技術タグの種類</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="names" class="leading-7 text-sm text-gray-600">▪️
                                                    タグ<br>カンマ + 半角スペース区切りで、複数入力OK</label>
                                                <input type="text" id="name" name="names"
                                                    value="{{ old('names') }}" placeholder="例)PHP, HTML, CSS"
